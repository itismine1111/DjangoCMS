...
const API_LINK_TYPE_URL = API_BASE_URL + "linktype/";
...
const EDIT_LINK_INFO_URL_ADMIN = BASE_URL_ADMIN + "linkinfo/edit/";
const ADD_LINK_TYPE_URL_ADMIN = BASE_URL_ADMIN + "linktype/add/";
